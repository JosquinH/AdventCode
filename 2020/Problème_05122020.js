 ...
 */
 ...
 allIdsList.sort((x,y) => x - y)

 const possibleIds = []

 for (let i = 0; i < 1024; ++i) {
     if (allIdsList.findIndex(x => x === i) === -1) {
         if (allIdsList.findIndex(x => x === i -1) !== -1 && allIdsList.findIndex(x => x === i + 1) !== -1 ) {
            possibleIds.push(i)    
         }
     } 
 }

 console.log(`Les ids possibles sont ${possibleIds}`)